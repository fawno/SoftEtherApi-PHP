...
namespace SoftEtherApi\Containers
{
    ...
    class SoftEtherNetwork
    {
        ...
        public static function SendHttpRequest($socket, $method, $target, $body, $headers)
        {
        ...
        public static function GetHttpResponse($socket)
        {
            ...
            $result = new Model\SoftEtherHttpResult();
